        ...
        <div className="flex flex-col sm:flex-row gap-2">
          ...
          <div className={cn(
            ...
            <div className="text-center">
              <div className="text-sm font-semibold text-neutral-900">{customers.length}</div>
                  ...
                  currentCustomers.map((customer) => (
                    <tr key={customer.id} className="hover:bg-neutral-50/50 transition-colors">
                      <td className="px-2 py-1.5">
                        <div>
                          <div className="text-[11px] font-medium text-neutral-900">{customer.customer_name}</div>
                          {customer.contact_person && (
                            <div className="text-[9px] text-neutral-400">{customer.contact_person}</div>
                          )}
                          {customer.ntn && (
                            <div className="text-[9px] text-neutral-400">NTN: {customer.ntn}</div>
                          )}
                        </div>
                      </td>
                      <td className="px-2 py-1.5">
                        <div className="text-[11px] text-neutral-600">{customer.mobile_no || '-'}</div>
                        {customer.whatsapp_no && (
                          <div className="text-[9px] text-neutral-400">WA: {customer.whatsapp_no}</div>
                        )}
                      </td>
                      <td className="px-2 py-1.5">
                        <div className="text-[11px] text-neutral-600">{customer.email || '-'}</div>
                      </td>
                      <td className="px-2 py-1.5">
                        <span className={cn(
