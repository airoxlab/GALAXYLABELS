      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-3 gap-2">
          <div className={cn(
            ...
            <div className="text-[10px] text-neutral-500">Total Expenses</div>
            <div className="text-sm font-semibold text-neutral-900">{expenses.length}</div>
          </div>
          <div className={cn(
            "bg-white/80 backdrop-blur-xl rounded-xl px-3 py-2",
            "border border-neutral-200/60"
          ...
          <div className={cn(
            ...
            <div className="text-sm font-semibold text-red-600">{formatCurrency(totalAmount)}</div>
          </div>
        </div>
                  ...
                  currentExpenses.map((expense) => (
                    <tr key={expense.id} className="hover:bg-neutral-50/50 transition-colors">
                      <td className="px-2 py-1.5">
                        <div className="text-[11px] font-medium text-neutral-900">{formatDate(expense.expense_date)}</div>
                      </td>
                      <td className="px-2 py-1.5">
                        <span className={cn(
                      ...
                      <td className="px-2 py-1.5">
                        <div className="text-[11px] text-neutral-900">{expense.description}</div>
                        {expense.notes && (
                      ...
                      <td className="px-2 py-1.5">
                        <div className="text-[11px] font-semibold text-red-600">{formatCurrency(expense.amount)}</div>
                      </td>
                      <td className="px-2 py-1.5">
