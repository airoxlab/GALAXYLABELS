  ...
  useEffect(() => {
    if (customer) {
      setFormData({
        ...
        ntn: customer.ntn || '',
        str: customer.str || '',
        opening_balance: customer.current_balance || 0,
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-3 py-2.5 bg-neutral-50/80 border rounded-xl text-sm placeholder:text-neutral-400 focus:outline-none focus:ring-2 focus:ring-neutral-900/10 focus:border-neutral-300 transition-all duration-200 ${
                errors.customer_name ? 'border-red-500' : 'border-neutral-200/60'
              }`}
            />
          ...
          {!customer && (
            <div>
              ...
              <p className="text-xs text-neutral-400 mt-1">
                Positive for receivable (customer owes), negative for payable (we owe)
              </p>
            </div>
          )}
