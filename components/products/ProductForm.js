          ...
          {!showCategoryAdd ? (
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 px-3 py-2.5 bg-neutral-50/80 border border-neutral-200/60 rounded-xl text-sm placeholder:text-neutral-400 focus:outline-none focus:ring-2 focus:ring-neutral-900/10 focus:border-neutral-300 transition-all duration-200"
              />
              <button
                type="button"
                onClick={() => {
                ...
                className="px-3 py-2 bg-neutral-900 text-white rounded-xl hover:bg-neutral-800 transition-all text-sm"
              >
                Save
              </button>
              <button
                ...
                className="px-3 py-2 bg-neutral-100 text-neutral-700 rounded-xl hover:bg-neutral-200 transition-all text-sm"
              >
                Cancel
              </button>
            </div>
